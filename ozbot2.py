"""Command-line Tic-Tac-Toe with an unbeatable AI"""
import os
import random
...
def choose_first():
    """Randomly decides which player has first turn"""
...
def space_check(board, position):
    """checks if player can make intended move"""
...
def replay():
    """asks whether or not game should be replayed"""
    choice = ''
...
def computer_choice(board,comp_mark,player_mark):
    """determines the computers next move by evaluating the Minimax algorithm"""
...
def minimax(board, depth, is_maximizing, comp_mark, player_mark):
    """explores possible gamestates from perspective of the computer"""
